    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      <nav className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <SignInButton mode="modal">
            <button className="text-sm font-bold text-text-main hover:text-primary transition-colors">{t('signIn')}</button>
          </SignInButton>
        </div>
      </nav>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center">
        ...
        <SignUpButton mode="modal">
          <button className="bg-primary text-white px-10 py-5 rounded-2xl font-black text-lg shadow-2xl shadow-primary/30 hover:scale-105 transition-all">{t('landingCta')}</button>
        </SignUpButton>
