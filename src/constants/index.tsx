...
import { Calendar, Send, Globe, Sparkles } from 'lucide-react';
import { Paper, TrendingTopic, StatItem, DailyData } from "../types";
...
export const DASHBOARD_STATS: StatItem[] = [
    { label: 'Days of Service', value: '1,248', trend: '+1', icon: <Calendar size={20} />, color: 'text-blue-600 bg-blue-50' },
    { label: 'Papers Sent', value: '84.2k', trend: '+12%', icon: <Send size={20} />, color: 'text-purple-600 bg-purple-50' },
    { label: 'Crawled Index', value: '2.4M', trend: '+5.4k', icon: <Globe size={20} />, color: 'text-emerald-600 bg-emerald-50' },
    { label: 'AI Summaries', value: '12.8k', trend: '+8%', icon: <Sparkles size={20} />, color: 'text-amber-600 bg-amber-50' },
];
